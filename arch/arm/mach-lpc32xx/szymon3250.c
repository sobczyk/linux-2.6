...
static struct gpio_led phy_leds[] = {
	{
		.name			= "led0",
		.gpio			= LPC32XX_GPIO(LPC32XX_GPO_P3_GRP, 0),
		.active_low		= 1,
		.default_trigger	= "heartbeat",
	},
	{
		.name			= "led1",
		.gpio			= LPC32XX_GPIO(LPC32XX_GPO_P3_GRP, 1),
		.active_low		= 1,
		.default_trigger	= "heartbeat",
	},
	{
		.name			= "led2",
		.gpio			= LPC32XX_GPIO(LPC32XX_GPO_P3_GRP, 14),
		.active_low		= 1,
		.default_trigger	= "heartbeat",
	},
	{
		.name			= "led3",
		.gpio			= LPC32XX_GPIO(LPC32XX_GPO_P3_GRP, 20),
		.active_low		= 1,
		.default_trigger	= "heartbeat",
	},
	{
		.name			= "led4",
		.gpio			= LPC32XX_GPIO(LPC32XX_GPO_P3_GRP, 5),
		.active_low		= 1,
		.default_trigger	= "heartbeat",
	},
	{
		.name			= "led5",
		.gpio			= LPC32XX_GPIO(LPC32XX_GPO_P3_GRP, 23),
		.active_low		= 1,
		.default_trigger	= "heartbeat",
	},
};
...
static void szymon3250_spi_cs_set(u32 control)
{
...
static struct pl022_config_chip spi0_chip_info = {
	...
	.cs_control		= szymon3250_spi_cs_set,
};


#if defined(CONFIG_MMC_SPI) || defined(CONFIG_MMC_SPI_MODULE)
#define MMC_SPI_CARD_DETECT_INT IRQ_LPC32XX_GPI_09
 
static int szymon3250_mmc_spi_init(struct device *dev,
        irqreturn_t (*detect_int)(int, void *), void *data)
{
        return request_irq(MMC_SPI_CARD_DETECT_INT, detect_int,
                IRQ_TYPE_EDGE_FALLING, "mmc-spi-detect", data);
}
 
static void szymon3250_mmc_spi_exit(struct device *dev, void *data)
{
        free_irq(MMC_SPI_CARD_DETECT_INT, data);
}
 
static struct mmc_spi_platform_data szymon3250_mmc_spi_pdata = {
        .init = szymon3250_mmc_spi_init,
        .exit = szymon3250_mmc_spi_exit,
...
arch_initcall(szymon3250_spi_devices_register);
...
static struct clcd_panel conn_lcd_panel = {
	.mode		= {
		...
		.xres		= 480,
		.yres		= 272,
		.pixclock	= 40000, //more than 24 fps 1 000 000/25
		.left_margin	= 10,
		.right_margin	= 10,
		.upper_margin	= 7,
		.lower_margin	= 7,
...
struct clcd_board lpc32xx_clcd_data = {
        .name           = "LG Phillips LB050WQ2 480x272 5\"",
        .check          = clcdfb_check,
 ...
 */
static int __init szymon3250_amba_devices_register(void)
{
	u32 i = 0;
...
device_initcall_sync(szymon3250_amba_devices_register);
...
static struct mtd_partition __initdata szymon3250_nand_partition[] = {
        {
                .name   = "szymon3250-boot",
                .offset = 0,
                .size   = (BLK_SIZE * 25)
        },
        {
                .name   = "szymon3250-uboot",
                .offset = MTDPART_OFS_APPEND,
                .size   = (BLK_SIZE * 102)
        },
        {
                .name   = "szymon3250-kernel",
                .offset = MTDPART_OFS_APPEND,
                .size   = (BLK_SIZE * 32)
        },
        {
                .name   = "szymon3250-jffs2",
                .offset = MTDPART_OFS_APPEND,
                .size   = MTDPART_SIZ_FULL
        },
};
static struct mtd_partition * __init szymon3250_nand_partitions(int size, int *num_partitions)
{
        *num_partitions = ARRAY_SIZE(szymon3250_nand_partition);
        return szymon3250_nand_partition;
}
struct lpc32XX_nand_cfg lpc32xx_nandcfg =
{
        ...
        .partition_info         = szymon3250_nand_partitions,
};
 ...
 */
void __init szymon3250_board_init(void)
{
	u32 tmp;
...
MACHINE_START (SZYMON3250, "Future Designs board with the LPC3250 Microcontroller")
	...
	.timer		= &lpc32xx_timer,
	.init_machine	= szymon3250_board_init,
	MACHINE_END

/* For backwards compatibility with older bootloaders only */
MACHINE_START (LPC3XXX, "Szymon Sobik's custom board with the LPC3250 Microcontroller")
	.phys_io	= LPC32XX_UART5_BASE,
	.io_pg_offst	= ((IO_ADDRESS(LPC32XX_HS_UART1_BASE))>>18) & 0xfffc,
	.boot_params	= 0x80000100,
	.map_io		= lpc32xx_map_io,
